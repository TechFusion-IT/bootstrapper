...
function Show-Step {
    ...
    switch ($Step) {
        1 { $frameStep1.Visibility = $Visible; $btnSkip.Visibility = $Collapsed }
        2 { $frameStep2.Visibility = $Visible; $btnSkip.Visibility = $Visible }
        3 { $frameStep3.Visibility = $Visible; $btnSkip.Visibility = $Visible }
        4 { $frameStep4.Visibility = $Visible; $btnSkip.Visibility = $Visible; $btnNext.Content = "Execute" }
    }
